...
const ratelimitOptions = rateLimit({
    ...
    legacyHeaders: false,
    handler:(req,res)=>{
        logger.warn(`Sensisitive route rate limit exceeded: ${req.ip}`);
...
app.use('/v1/auth',proxy(process.env.IDENTITY_SERVICE_URL, {
    ...
    userResDecorator: (proxyRes, proxyResData, userReq, userRes) => {
        // You can modify the response from the proxied service here if needed
...
// setting up a prox for media service
